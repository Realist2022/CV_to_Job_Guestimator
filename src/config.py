...
# Local model used to inspect the raw CV for skill names.
# MODEL_NAME = os.getenv("SKILL_NAME_MODEL_NAME", "llama3.2:latest")
# MODEL_BASE_URL = os.getenv("SKILL_NAME_MODEL_BASE_URL", "http://localhost:11434/v1")
# MODEL_API_KEY = os.getenv("SKILL_NAME_MODEL_API_KEY", "ollama")
# MODEL_TEMPERATURE = float(os.getenv("MODEL_TEMPERATURE", 0.0))
...
SKILLS_MATCH_WEIGHT = float(os.getenv("SKILLS_MATCH_WEIGHT", 0.60))
WORK_EXPERIENCE_WEIGHT = float(os.getenv("WORK_EXPERIENCE_WEIGHT", 0.40))